...
void
handle_mmeapp_message_s10(void * data)
{
...
init_gtpv2()
{
	fprintf(stderr, "....................inside s10 socket creation\n");
	/*Create UDP socket*/
	...
	//************* g_s10_cp_addr will be filled from mme config ************//
	/*Configure settings in address struct*/
	g_s10_cp_addr.sin_family = AF_INET;
	//g_s10_cp_addr.sin_port = htons(g_s10_cfg.egtp_def_port);
	fprintf(stderr, ".................... egtp def port %d\n", g_s10_cfg.egtp_def_port);
	g_s10_cp_addr.sin_port = htons(g_s10_cfg.egtp_def_port);
	//g_s10_cp_addr.sin_addr.s_addr = htonl(g_s10_cfg.sgw_ip);
	struct in_addr sgw_addr = {g_s10_cfg.sgw_ip};
	fprintf(stderr, "....................sgw ip %s\n", inet_ntoa(sgw_addr));
	g_s10_cp_addr.sin_addr.s_addr = g_s10_cfg.sgw_ip;
	memset(g_s10_cp_addr.sin_zero, '\0', sizeof(g_s10_cp_addr.sin_zero));
